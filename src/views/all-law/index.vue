  ...
  <div>
    ...
    <main class="container">
      <div class="breadcrumb">
        <RouterLink to="/">首页</RouterLink> > <RouterLink to="/all-law">法律法规</RouterLink> > <span>全部法律</span>
      </div>
        ...
        <table class="law-table">
          ...
          <tbody>
            ...
            <tr v-for="law in paginatedLaws" :key="law.name">
              <td>
                <RouterLink class="law-name" :to="{ name: 'LawDetail', params: { name: law.name } }">{{ law.name }}</RouterLink>
              </td>
              ...
              <td><RouterLink :to="{ name: 'LawDetail', params: { name: law.name } }">查看</RouterLink></td>
            </tr>
          </tbody>
        </table>
      </div>
      ...
      <div class="pagination" v-if="filteredLaws.length > 0">
        ...
        <div class="page-item" v-for="page in visiblePages" :key="page">
